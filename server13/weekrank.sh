#!/bin/bash
rm weekrank.sql
LIB_PATH=./lib/antlr-2.7.6.jar:./lib/backport-util-concurrent-3.0.jar:./lib/commons-logging-1.1.1.jar
LIB_PATH=$LIB_PATH:./lib/hibernate-annotations.jar:./lib/log4j-1.2.11.jar:./lib/asm-3.1.jar:./lib/c3p0-0.9.1.jar
LIB_PATH=$LIB_PATH:./lib/db.jar:./lib/:./lib/hibernate-commons-annotations.jar:./lib/mina-core-1.1.7.jar
...
LIB_PATH=$LIB_PATH:./lib/mysql-connector-java-5.0.8-bin.jar:./lib/asm-commons-3.1.jar:./lib/commons-collections-3.2.jar
...
/usr/bin/java -server -Xms1024m -Xmx1024m -verbose:gc -XX:+PrintGCDetails  -XX:+PrintGCTimeStamps  -XX:+UseFastAccessorMethods -XX:CMSInitiatingOccupancyFraction=80 -XX:+UseConcMarkSweepGC -Djava.awt.headless=true -classpath "./lib/peony.jar:$CLASSPATH:.:$LIB_PATH" peony.stat.WeeklyRankCalculator>>stdout.log 2>&1 
mysql -usanguo -p"yes&2009@at" -h10.10.10.43 -P3306 sanguo_13<weekrank.sql
echo "update ok"
