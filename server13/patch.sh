...
/usr/bin/java -server -Xms1024m -Xmx1024m -verbose:gc -XX:+PrintGCApplicationStoppedTime -XX:+PrintGCDetails  -XX:+PrintGCTimeStamps  -XX:+UseFastAccessorMethods -XX:CMSInitiatingOccupancyFraction=80 -XX:+UseConcMarkSweepGC -Djava.awt.headless=true -classpath "./lib/peony.jar:$CLASSPATH:.:$LIB_PATH" peony.test.DataPatch1 >> stdout.log 2>&1 &
